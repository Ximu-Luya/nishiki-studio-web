 ...
 */
function success0(res, message, data) {
  console.log(message)
  res.json({
    code: 200,
    message,
 ...
 * @param {Object} res response对象
 */
function adminForbiddenCheck(req, res) {
 ...
 * @param {Object} res response对象
 */
function contributorForbiddenCheck(req, res) {
